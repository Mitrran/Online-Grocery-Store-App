...
public class Stat extends AppCompatActivity implements IDrinkLoadListener, ICartLoadListener {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (adapterView.getItemAtPosition(i).equals("Choose Category")) {
                    ...
                    if (adapterView.getItemAtPosition(i).equals("Food & Beverages")) {
                        Intent intent = new Intent(Stat.this, FNB.class);
                        startActivity(intent);
                    } else if (adapterView.getItemAtPosition(i).equals("Stationary")) {
                        Intent intent = new Intent(Stat.this, Stat.class);
                        startActivity(intent);
                    } else if (adapterView.getItemAtPosition(i).equals("Toiletries")) {
                        Intent intent = new Intent(Stat.this, Toil.class);
                        startActivity(intent);
                    }
                    else if (adapterView.getItemAtPosition(i).equals("Back To Home")) {
                        Intent intent = new Intent(Stat.this, HomePage.class);
                        startActivity(intent);
                    }
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists())
                        {
                            ...
                            drinkLoadListener.onDrinkLoadFailed("cant find stationary");
